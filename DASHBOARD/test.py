...
def index():
    ...
    list_x = [('Month_num', 'Month'), ('City2', 'Destination'), ('day', 'Day'), ('time', 'Time')]
    list_y = [('ASKs', 'asks'), ('tip', 'Tip'), ('size', 'Size')]
    list_est = [('count', 'Count'), ('avg', 'Average'), ('max', 'Max'), ('min', 'Min')]
    list_hue = [('Month_num', 'Month'), ('City2', 'Destination'), ('day', 'Day'), ('time', 'Time')]
